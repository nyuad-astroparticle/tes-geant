...
//Removed all things meant to be used with CRY
//(Replacing CRY with GeneralParticleSource for radioactivity sim)
...
class G4GeneralParticleSource;                                  // Get it? Because it makes any general particle XDDDDD
